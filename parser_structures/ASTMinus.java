...
public class ASTMinus implements ASTNode {
    ...
    public ASTMinus(ASTNode l, ASTNode r, Context ctx) {
        left = l;
        right = r;
        this.ctx = ctx;
    }
    ...
    public Expr getAssertion(boolean assertion_context) {
    	return ctx.mkSub((ArithExpr) left.getAssertion(assertion_context), (ArithExpr) right.getAssertion(assertion_context));
    }
