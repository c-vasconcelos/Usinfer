...
public class ASTDiv implements ASTNode {
    ...
    public ASTDiv(ASTNode l, ASTNode r, Context ctx) {
        left = l;
        right = r;
        this.ctx = ctx;
    }
    ...
    public Expr getAssertion(boolean assertion_context) {
    	return ctx.mkDiv((ArithExpr) left.getAssertion(assertion_context), (ArithExpr) right.getAssertion(assertion_context));
    }
