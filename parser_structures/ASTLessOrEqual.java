...
public class ASTLessOrEqual implements ASTNode {
    ...
    public ASTLessOrEqual(ASTNode l, ASTNode r, Context ctx) {
        left = l;
        right = r;
        this.ctx = ctx;
    }
    ...
    public Expr getAssertion(boolean assertion_context) {
    	return ctx.mkLe((ArithExpr) left.getAssertion(assertion_context), (ArithExpr) right.getAssertion(assertion_context));
    }
